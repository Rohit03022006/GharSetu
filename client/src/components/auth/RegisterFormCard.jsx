...
import { UserPlus, Lock, Mail, User, Phone, Shield } from 'lucide-react';
...
export const RegisterFormCard = () => {
  ...
  const handleGoogleOAuth = () => {
    ...
    window.location.href = `${gatewayUrl}/auth/google?mode=register`;
  };
    ...
    <Card className="max-w-md w-full p-2 border-border shadow-sm">
      <CardHeader className="text-center space-y-1">
        ...
        <CardDescription className="text-xs text-muted-foreground">
          Join GharSetu to search, list, or manage properties
        </CardDescription>
      </CardHeader>
